...
import diruptio.verticallyspinningfish.api.ContainerData;
...
public class VerticallySpinningFish {
    ...
    public static void main(String[] args) throws IOException {
        // Simple configuration using system properties and environment variables
        String dockerHost = System.getProperty("docker.host", 
                System.getenv("DOCKER_HOST") != null ? System.getenv("DOCKER_HOST") : "unix:///var/run/docker.sock");
        secret = System.getProperty("vsf.secret", 
                System.getenv("VSF_SECRET") != null ? System.getenv("VSF_SECRET") : Hashing.sha256().hashLong(System.currentTimeMillis()).toString());
        containerPrefix = System.getProperty("vsf.container.prefix", 
                System.getenv("VSF_CONTAINER_PREFIX") != null ? System.getenv("VSF_CONTAINER_PREFIX") : "vsf-");
